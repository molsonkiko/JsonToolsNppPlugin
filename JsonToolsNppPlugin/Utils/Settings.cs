...
namespace JSON_Tools.Utils
{
    ...
    public class Settings : SettingsBase
    {
        ...
        [Description("Whether JsonTools automatically assigns default keyboard shortcuts to some plugin commands at startup.\r\n" +
        ...
        public bool keyboard_shortcuts { get; set; }
