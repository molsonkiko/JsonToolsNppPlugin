...
namespace JSON_Tools.Tests
{
    public class UserInterfaceTester
    {
        ...
        public static bool Test()
        {
            ...
            KeyStyle previousKeyStyle = Main.settings.key_style;
            string previousPathSeparator = Main.settings.path_separator;
            ...
            Main.settings.path_separator = "\"\\u0001\"";
            Main.settings.key_style = KeyStyle.RemesPath;
            ...
            Main.settings.key_style = previousKeyStyle;
            Main.settings.path_separator = previousPathSeparator;
