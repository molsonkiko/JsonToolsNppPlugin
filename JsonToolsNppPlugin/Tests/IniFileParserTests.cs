        ...
        public static bool Test()
        {
                ...
                (string path, int utf8pos)[])[]
            {
                ...
                new (string path, int iniUtf8pos)[]
                {
                    ...
                    ("indented section]key indent", 416),
                    (" dedented section ", 531),
                    ("interpolation from other sections]baz", 912),
                    ("special\\_chars]non-colon, non-equals special chars in [\"#keys\"];", 1393),
                }),
