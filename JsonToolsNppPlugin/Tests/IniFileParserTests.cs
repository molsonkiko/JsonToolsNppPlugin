        ...
        public static bool Test()
        {
                ...
                (string path, int utf8pos)[])[]
            {
                ...
                new (string path, int iniUtf8pos)[]
                {
                    ...
                    ("indented section]key indent", 415),
                    (" dedented section ", 530),
                    ("interpolation from other sections]baz", 911),
                    ("special\\_chars]non-colon, non-equals special chars in [\"#keys\"];", 1391),
                }),
