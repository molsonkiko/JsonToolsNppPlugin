...
3. Add [`D&ump selected text as JSON string(s)`](/docs/README.md#escaping-text-as-a-json-string) and [`Dump JSON string(s) as ra&w text`](/docs/README.md#unescaping-a-json-string-to-raw-text) convenience methods.
